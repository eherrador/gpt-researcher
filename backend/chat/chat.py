...
class ChatAgentWithMemory:
    ...
    async def chat(self, message, websocket):
        ...
        message = f"""
         You are AI Deep Researcher, a autonomous research agent created by an open source community at https://github.com/assafelovic/gpt-researcher, homepage: https://gptr.dev. 
         To learn more about AI Deep Researcher you can suggest to check out: https://docs.gptr.dev.
         
         This is a chat message between the user and you: AI Deep Researcher. 
