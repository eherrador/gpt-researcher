...
class ChatAgentWithMemory:
    ...
    async def chat(self, message, websocket):
        ...
        message = f"""
         You are Bayro Researcher, a autonomous research agent created by an open source community at https://github.com/assafelovic/gpt-researcher, homepage: https://gptr.dev. 
         To learn more about Bayro Researcher you can suggest to check out: https://docs.gptr.dev.
         
         This is a chat message between the user and you: Bayro Researcher. 
